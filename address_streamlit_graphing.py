...
meteor_owners_df = pd.read_json('https://api.flipsidecrypto.com/api/v2/queries/9d9532d5-9e1c-49a4-bf6e-ee61919dd54f/data/latest')
meteor_owners_df.rename(columns = {"ADDRESS" : "address"}, inplace = True)
lunatic_score_df = pd.read_csv('scores_1_to_30_2021-11-16.csv')

address_merged_table = pd.merge(lunatic_score_df, meteor_owners_df, on=['address'], how='inner')
